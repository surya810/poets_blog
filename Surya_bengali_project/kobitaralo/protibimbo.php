...
<div style="margin-left: 25px; margin-top :10px;">
       ...
       <a href="index.php"class="active" style="background-color: transparent;">
            <center><img id="spl" src="img/KOsitebanne3r.png" height="auto" width="80%" ></a><!--logo image-->
...
<h2 style="display:inline;text-shadow: 2px 2px grey;">&nbsp;&nbsp;<strong>প্রতিবিম্ব</strong></h2>&nbsp;&nbsp;
<img src="img/v.png" style="display: inline;width: 90px; height: 80px;margin-bottom: 5px;">
...
<div class="dropdown1" style="display:inline;">
 ...
 <?php
  ...
  <div class="card-deck" style="margin-top: 50px;cursor: pointer;  margin-right: 0px;">
    ...
    $res = "SELECT * FROM blog where selects ='Protibimbo' ORDER By id DESC"; //it will show the the card in desc order according to ID
   ...
   <form action=\"protibimbo.php?id = $id\" method='post'>
