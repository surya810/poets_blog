...
<body style=" background-image: url('img/b.jpg'); background-size: cover; overflow-x: hidden;">
  ...
  <h2 style="display:inline;text-shadow: 2px 2px grey;">&nbsp;&nbsp;<strong>অন্যভুবন</strong></h2>&nbsp;&nbsp;
  <img src="img/p.png" style="display: inline;width: 90px; height: 80px;margin-bottom: 5px;">
  ...
  <div class="dropdown" style="display:inline; margin-left: 240px;">
    ...
    <div class="dropdown-content" style="margin-left: 520px;">
      <a href="#"><strong>শ্রুতি- কিছু কথা, মৃণাল বসুচৌধুরী</strong></a>
      <a href="#"><strong>আজকের দিনের কবিতায় ছন্দ ব্যবহার ও অব্যবহার, চৈতালী ব্রহ্ম </strong></a>
  ...
  <div class="dropdown1" style="display:inline;">
    ...
    <div class="dropdown1-content" style="margin-left:600px;">
      ...
      <a href="kandari.php " style="text-decoration: none;"><strong>আহরণ </strong></a>
    </div>
  </div>

  <!-- php starts from line no 112 -->
    ...
    if ($result1->num_rows > 0) {
      ...
      while ($row = $result1->fetch_assoc()) {
        ...
        $element = "
          ...
          <div id=\"onnovubhan\" class=\"overlay\">
  ...
  <div class="card-deck" style="margin-top: 50px;cursor: pointer;  margin-right: 0px;">
    ...
    $res = "SELECT * FROM blog where selects='Onnovubhan' ORDER By id DESC"; //it will show the the card in desc order according to ID
   ...
   <form action=\"onnovubhan.php?id = $id\" method='post'>
