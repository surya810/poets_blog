...
<div style="margin-left: 25px; margin-top :10px;">
    ...
    <h2 style="display:inline;text-shadow: 2px 2px grey;">&nbsp;&nbsp;<strong>রূপান্তর</strong></h2>&nbsp;&nbsp;
    <img src="img/n.png" style="display: inline;width: 90px; height:80px; margin-bottom: 5px;">
    ...
    if (isset($_POST["view"])) {
     ...
     if ($result1->num_rows > 0) {
      ...
      <div class="card-deck" style="margin-top: 50px;cursor: pointer;  margin-right: 0px;">
          <!-- card's logic starting from here -->
      <?php
       $link = mysqli_connect("localhost", "root", "", "rgs");
       if($link === false){
        die("ERROR: Could not connect. " . mysqli_connect_error());
      }
       $res = "SELECT * FROM blog where selects ='Rupantor' ORDER By id DESC";
       ...
       if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
          ...
          $name=$row['name'];
          $element="
<form action=\"rupantor.php?id=$id\" method='post'>
            <div class=\"flip-card\" style=\"Margin-left: 50px; text-align: center; margin-top: 30px;\">
                <div class=\"flip-card-inner\">
                  ...
                  <div class=\"flip-card-back\">
                    <h6>$title</h6> 
                    <p>$date</p>
                    <span style=\"font-size:30px;cursor:pointer;\"> <button name=\"view\"style=\"margin-bottom: 10%;background: grey; border: none; padding: 10px; color: white; width: 40%; border-radius: 25px;font-size: 20px;\"><a href=\"show.php?id=$id\" style = \"text-decoration: none ; color: white;\">Read </a></button></span>
                  </div>
                </div>
              </div>
              </form>
