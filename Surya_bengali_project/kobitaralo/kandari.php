...
<body style=" background-image: url('img/b.jpg'); background-size: cover;overflow-x: hidden;">
  ...
  <h2 style="display:inline;text-shadow: 2px 2px grey;">&nbsp;&nbsp;<strong>কান্ডারী</strong></h2>&nbsp;&nbsp;
  <img src="img/r..png " style="display: inline; width: 80px; height: 70px;margin-bottom: 5px;">
  ...
  <div class="dropdown" style="display:inline; margin-left: 240px;">
    ...
    <div class="dropdown-content" style="margin-left: 520px;">
      <a href="#"><strong>সোনার হরিণ, নারায়ণ বিশ্বাস </strong></a>
      <a href="#"><strong>যাপন, বৈজয়ন্ত রাহা</strong></a>
      <a href="#"><strong>আঁধারের শেষে, নন্দিনী সেনগুপ্ত </strong></a>
      <a href="#"><strong>আকাশগঙ্গা, চয়ন সমাদ্দার </strong></a>
      <a href="#"><strong> প্রতিদান, দীপঙ্কর মুখোপাধ্যায় </strong></a>
      <a href="#"><strong> অন্য মানুষ, পিনাকী দত্ত গুপ্ত </strong></a>
      <a href="#"><strong>শেষ দফায়, কাকলি দাশ ব্যানার্জী </strong></a>
      <a href="#"><strong>বিষ, <br> কৌশিক চক্রবর্তী </strong></a>
      <a href="#"><strong>নিমগাছ,<br> রাহুল গুহ </strong></a>
  ...
  <div class="card-deck" style="margin-top: 50px;cursor: pointer;  margin-right: 0px;">
    ...
    $res = "SELECT * FROM blog where selects='Kandari' ORDER By id DESC"; //it will show the the cards in desc order according to ID
   ...
   <form action=\"kandari.php?id = $id\" method='post'>
                ...
                <div class=\"flip-card-inner\">
                  ...
                  <div class=\"flip-card-back\">
                    ...
                    <span style=\"font-size:30px; cursor:pointer;\" > 
                      <button style=\"margin-bottom: 10%; background: grey; border: none; padding: 10px; color: white;   width: 40%; border-radius: 25px; border-color: 0 px; font-size: 20px;\"> <a href=\"show.php?id=$id\" style = \"text-decoration: none; color: white;\"> Read </a>
                      </button>
                    </span>
